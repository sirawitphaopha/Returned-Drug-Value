...
//
// ✅ ชื่อยาที่แสดงทุกหน้า ใช้ "ชื่อปัจจุบันจากคลัง" ไม่ใช่ชื่อที่แช่ไว้ตอนบันทึก
//    พี่กันเคาะ 8 ก.ย. 2569: "ชื่อยาที่เปลี่ยนควรเป็นปัจจุบัน เพราะไม่งั้นมันไม่สวย
//    และการเปลี่ยนชื่อยา เราไม่ได้เปลี่ยนชนิดยาสักหน่อย เราอาจจะแค่ใส่บางคำเพิ่มแค่นั้น"
//
//    ทำที่ชั้นฐานข้อมูล — ฟังก์ชัน mr_drug_label(d, ชื่อที่แช่ไว้) ประกอบชื่อจากคลัง
//    แล้วตกกลับไปใช้ชื่อที่แช่ไว้เมื่อแถวนั้นไม่มีรหัสยา หรือยาถูกลบจากคลังไปแล้ว
//    ใช้ครบทุกทาง — mr_history · mr_lot_rows · mr_lot_log · mr_summary · mr_top_returned
//
// 🚨 ราคากับหน่วยยังแช่ไว้เหมือนเดิม ห้ามดึงของปัจจุบันมาใช้
//    ราคาเปลี่ยน = มูลค่าเปลี่ยนจริง ตัวเลขย้อนหลังต้องไม่ขยับ
//    ชื่อเปลี่ยน = คำเรียกของสิ่งเดิม ทุกที่ควรเรียกให้ตรงกัน
//    Top 10 หน้าสรุปจับกลุ่มด้วย drug_id ไม่ใช่ชื่อ (008_group_by_drug_id.sql)
