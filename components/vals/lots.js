...
const COLS = [
  ...
  { key: 'by',    label: 'ผู้บันทึก',    w: '164px' },
  ...
  // 🚨 88 ไม่ใช่ 76 — หัวคอลัมน์ "รายการ" พร้อมลูกศรกินจริง 87 จุด
  //    ที่ 76 หัวถูกบีบจนลูกศรเบียดตัวหนังสือ (วัดจริง 10 ก.ย. 2569)
  ...
  { key: 'total', label: 'รวม',        w: '106px', align: 'right' },
