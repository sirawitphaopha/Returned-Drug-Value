...
export function recordVals(app, d) {
  ...
  return {
    ...
    sources: SOURCES.map((s) => ({
      label: s.label,
      // ชื่อสั้นสำหรับจอมือถือ — ฝั่งเดสก์ท็อปยังใช้ label เต็มเหมือนเดิม
    ...
    // ครั้งนี้มีมูลค่าแล้วหรือยัง — แถบบันทึกฝั่งมือถือใช้ซ่อนบรรทัดสัดส่วนตอนยังว่าง
    // (พี่กันสั่ง 1 ก.ย. 2569 "บรรทัดเล็ก ๆ เอาออก ที่เขียนว่ายังไม่มีมูลค่าครั้งนี้")
    // 🚨 แผงขวาฝั่งคอมยังโชว์ proportionLabel เหมือนเดิมทุกกรณี ห้ามแตะ
    hasGross: !!d.gross,
