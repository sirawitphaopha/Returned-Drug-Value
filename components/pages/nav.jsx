  ...
  return (
    ...
    <div style={s('width:100%;max-width:1400px;margin:0 auto;display:flex;align-items:center;justify-content:space-between;padding:12px 26px')}>
      ...
      <div style={s('display:flex;align-items:center;gap:12px')}>
        ...
        <div {...kb(V.openAbout)} aria-label="เกี่ยวกับ" className={V.aboutOn ? 'hv-bg-e3f' : 'hv-bg-f6'} style={sx('min-height:38px;padding:0 13px;border-radius:9px;display:inline-flex;align-items:center;font:600 12.5px/1.75 Sarabun,sans-serif;cursor:pointer', V.aboutOn ? { border: '1px solid rgba(47,125,93,.34)', background: '#e3f0e8', color: '#2f7d5d' } : { border: '1px solid rgba(30,36,32,.14)', color: '#414a44' })}>เกี่ยวกับ</div>
        <div {...kb(V.openSettings)} aria-label="ตั้งค่า" className={V.settingsOn ? 'hv-bg-e3f' : 'hv-bg-f6'} style={sx('min-height:38px;padding:0 13px;border-radius:9px;display:inline-flex;align-items:center;font:600 12.5px/1.75 Sarabun,sans-serif;cursor:pointer', V.settingsOn ? { border: '1px solid rgba(47,125,93,.34)', background: '#e3f0e8', color: '#2f7d5d' } : { border: '1px solid rgba(30,36,32,.14)', color: '#414a44' })}>ตั้งค่า</div>
      </div>
    </div>
    </div>
  );
