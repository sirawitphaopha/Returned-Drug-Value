              ...
              <div style={s('display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap')}>
                <div style={s('min-width:150px;flex:1')}>
                  <div style={s('font:600 14.5px/1.3 Sarabun,sans-serif')}>
                    ...
                    {p.hasAbbrev && <span style={s("font-weight:600;color:#6d3b9e;font-family:var(--font-plex),'IBM Plex Sans Thai',sans-serif;margin-left:5px")}>({p.abbrev})</span>}
                    ...
                    {p.hasRelease && <span style={s("font-weight:700;font-style:italic;color:#b02a5b;font-family:var(--font-plex),'IBM Plex Sans Thai',sans-serif;margin-left:5px")}>{p.releaseLabel}</span>}
