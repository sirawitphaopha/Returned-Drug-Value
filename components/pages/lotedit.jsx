        ...
        {(V.lotEditLoading || V.skelDemo) ? (
          ...
          <>
            ...
            <div style={s('padding:15px 20px;border-bottom:1px solid #eef1ee')}>
              ...
              <div style={s('display:flex;gap:18px;flex-wrap:wrap')}>
                ...
                <div>
                  ...
                  <input type="date" value={V.lotEditDate} onChange={V.onLotEditDate} max={V.lotEditDateMax}
                    style={sx("width:190px;height:42px;padding:0 11px;border-radius:9px;background:#fff;font:400 13.5px Sarabun,sans-serif;color:#1e2420;outline:none",
              ...
              <div style={s('margin-top:13px')}>
                ...
                {V.lotEditPcu && V.lotEditPcu.pcuOn && V.lotEditSiteChanged && (
                  <div style={s('font:500 11px Sarabun,sans-serif;color:#96650f;margin-top:9px;margin-bottom:-4px;text-align:right')}>
            ...
            <div style={s('max-height:340px;overflow-y:auto;border-bottom:1px solid #eef1ee')}>
              <div style={s("display:flex;padding:9px 20px;background:#f8f9f7;border-bottom:1px solid #eef1ee;font:600 11.5px Sarabun,sans-serif;color:#6b746e;position:sticky;top:0;z-index:2")}>
